...
const DownloadPage = () => {
  ...
  return (
    <>
      <Head>
        <title>DocuMane - Download Word File</title>
      </Head>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl text-center">
          <h1 className="text-3xl font-bold mb-4 text-gray-800">Your Word File is Ready!</h1>
          <p className="text-gray-600 mb-8">Click the button below to download your converted Word file.</p>
          {decodedUrl ? (
            <button 
          ...
          <div className="mt-8">
            <button
              onClick={() => router.push('/pdfToWord/pdfToWord')}
