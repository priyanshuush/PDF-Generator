...
const DownloadPage = () => {
  ...
  return (
    <>
      <Head>
        <title>DocuMane - Download Translated PDF</title>
      </Head>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl text-center">
          <h1 className="text-3xl font-bold mb-4 text-gray-800">Your Translated PDF is Ready!</h1>
          <p className="text-gray-600 mb-8">Click the button below to download your translated PDF file.</p>
          {decodedUrl ? (
            <button 
          ...
          <div className="mt-8">
            <button
              onClick={() => router.push('/translatePDF')}
